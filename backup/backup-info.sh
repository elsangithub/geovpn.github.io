...
cekdata=$(curl -sS https://raw.githubusercontent.com/geovpn/user-backup/main/$NameUser/$NameUser-last-backup | grep 404 | awk '{print $1}' | cut -d: -f1)
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
data=$(curl -sS https://raw.githubusercontent.com/geovpn/user-backup/main/$NameUser/$NameUser-last-backup)
echo
