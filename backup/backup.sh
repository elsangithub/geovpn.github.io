...
LLatest=`date`
Get_Data () {
git clone https://github.com/geovpn/user-backup.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/geovpn/user-backup.git
    git push -f https://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@github.com/geovpn/user-backup.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/geovpn/user-backup/main/$NameUser/$NameUser.zip"
sleep 1
