...
wget -q -O /usr/bin/add-host "https://raw.githubusercontent.com/geovpn/scz/main/ssh/add-host.sh" && chmod +x /usr/bin/add-host
wget -q -O /usr/bin/about "https://raw.githubusercontent.com/scz/main/ssh/about.sh" && chmod +x /usr/bin/about
