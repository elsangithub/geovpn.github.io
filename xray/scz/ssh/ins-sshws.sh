...
wget -q -O /usr/bin/proxy3.js "https://bhm-vpn.com/asu/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://bhm-vpn.com/asu/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
