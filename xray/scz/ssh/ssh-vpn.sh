...
wget -q -O /usr/bin/badvpn-udpgw "https://github.com/geovpn/ranjau-darate/raw/main/newudpgw"
...
wget -q https://github.com/geovpn/ranjau-darat/raw/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
mv /usr/local/ddos/ddos.conf http://www.inetbase.com/scripts/ddos/ddos.conf
mv /usr/local/ddos/LICENSE http://www.inetbase.com/scripts/ddos/LICENSE
mv /usr/local/ddos/ignore.ip.list http://www.inetbase.com/scripts/ddos/ignore.ip.list
mv /usr/local/ddos/ddos.sh http://www.inetbase.com/scripts/ddos/ddos.sh
